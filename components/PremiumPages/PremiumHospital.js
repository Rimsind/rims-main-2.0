            ...
            <div className="row align-items-center">
              <div className="col-6">
                <div className="why_choose_heading bg-custom-info pt-4 pb-2 ps-3 pe-3">
                  <p className="lh-1">
                    <span className="first_choose_text">Why Choose Us</span>
                ...
                <div className="why_choose_para mt-3 ms-2">
                  <p className="fs-6">
                    ...
                    Duis quis dignissim sapien. Nunc quam tellus, rhoncus nec
                    ...
                    auctor bibendum lacus. Nunc quam tellus, rhoncus nec orci
                    ac, auctor bibendum lacus.
                  </p>
                ...
                <div className="col-3">
                  <div className="doctors-content-item">
                    ...
                    <div className="doctors-content-name">
                      <p className="fs-5 text-center">Prasenjit Kamila</p>
                    </div>
